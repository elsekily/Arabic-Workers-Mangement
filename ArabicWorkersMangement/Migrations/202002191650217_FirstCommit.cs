namespace ArabicWorkersMangement.Migrations
{
    ...
    public partial class FirstCommit : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DayDuration = c.Double(nullable: false),
                        Employee_ID = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                ...
                c => new
                    {
                        ...
                        SalaryPerHour = c.Double(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Days", "Employee_ID", "dbo.Employees");
            ...
            DropIndex("dbo.Days", new[] { "Employee_ID" });
